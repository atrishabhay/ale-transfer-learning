    ...
    def __init__(self, game):
        ...
        if game == 'ADV':
            self._templates = {
                ...
                'son4' :{  'path':'ob_detection/images/templates/sonic/son4.png',
                            'color': (3, 255, 32),
                            'threshold': self.threshold,
                            },
                'son5' :{  'path':'ob_detection/images/templates/sonic/son5.png',
                            'color': (3, 255, 32),
                            'threshold': self.threshold,
                            },
                'son6' :{  'path':'ob_detection/images/templates/sonic/son6.png',
                            'color': (3, 255, 32),
                            'threshold': self.threshold,
                            },
                'son7' :{  'path':'ob_detection/images/templates/sonic/son7.png',
                            'color': (3, 255, 32),
                            'threshold': self.threshold,
                            },
                'son8' :{  'path':'ob_detection/images/templates/sonic/son8.png',
                            'color': (3, 255, 32),
                            'threshold': self.threshold,
                            },
                'son9' :{  'path':'ob_detection/images/templates/sonic/son9.png',
                            'color': (3, 255, 32),
                            'threshold': self.threshold,
                            },
                'son10' :{  'path':'ob_detection/images/templates/sonic/son10.png',
                            'color': (3, 255, 32),
                            'threshold': self.threshold,
                            },
