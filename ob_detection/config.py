    ...
    def __init__(self, game):
        ...
        if game == 'sonic':
            self._templates = {
                ...
                'obs1'  :{  'path':'ob_detection/images/templates/sonic/obs1.png',
                            'color': (255, 162, 0),
                            'threshold': self.threshold,
                            },
                'obs3'  :{  'path':'ob_detection/images/templates/sonic/obs3.png',
                            'color': (255, 162, 0),
                            'threshold': self.threshold,
                            },
                'obs2'  :{  'path':'ob_detection/images/templates/sonic/obs2.png',
                            'color': (255, 162, 0),
                            'threshold': self.threshold,
                            },
                ...
                'ground3' :{  'path':'ob_detection/images/templates/sonic/ground3.png',
                            'color': (255, 162, 0),
                            'threshold': self.threshold,
                },
            }
